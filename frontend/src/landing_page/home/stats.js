            ...
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+ crore customers trust Zerodha with ₹3.5+ 
                        lack crores worth of equity</p>

                    <h2 className='fs-4'>No spam or gimmicks</h2>
                    <p className='text-muted'>No gimmicks,spam,"gamification",or annoying push 
                        notifiactions. High quality apps that you use at your pace, the way you like</p>
                    ...
                    <p className='text-muted'>With iniatives like Nudge and kill Switch, we don't just facilitate transactions, 

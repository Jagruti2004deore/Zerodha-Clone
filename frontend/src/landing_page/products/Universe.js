   ...
   return(
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/streakLogo.png" style={{width: "145px"}} />
          <p className="text-small text-muted">Algo & strategy plateform</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="/media/sensibullLogo.svg" style={{width: "145px"}}/>
          <p className="text-small text-muted">Options trading plateform</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="/media/zerodhaFundhouse.png" style={{width: "145px"}}/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="/media/dittoLogo.png" style={{width: "135px"}} />
